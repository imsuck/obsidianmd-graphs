	...
	load() {
		...
		if (saved) {
			try {
				...
				if (data.vaultPath !== undefined) this.vaultPath = data.vaultPath;
				if (data.linkMode !== undefined) this.linkMode = data.linkMode;
				if (data.tagMode !== undefined) this.tagMode = data.tagMode;
				if (data.globalAlgorithmId !== undefined) this.globalAlgorithmId = data.globalAlgorithmId;
				if (data.louvainResolution !== undefined) this.louvainResolution = data.louvainResolution;
				if (data.spectralK !== undefined) this.spectralK = data.spectralK;
				if (data.spectralScale !== undefined) this.spectralScale = data.spectralScale;
				if (data.spectralAspectRatio !== undefined) this.spectralAspectRatio = data.spectralAspectRatio;
				if (data.node2vecP !== undefined) this.node2vecP = data.node2vecP;
				if (data.node2vecQ !== undefined) this.node2vecQ = data.node2vecQ;
				if (data.node2vecIterations !== undefined) this.node2vecIterations = data.node2vecIterations;
				if (data.node2vecWalkLength !== undefined) this.node2vecWalkLength = data.node2vecWalkLength;
				if (data.metricId !== undefined) this.metricId = data.metricId;
				if (data.layoutMode !== undefined) this.layoutMode = data.layoutMode;
				if (data.showArrows !== undefined) this.showArrows = data.showArrows;
				if (data.blendCommunities !== undefined) this.blendCommunities = data.blendCommunities;
